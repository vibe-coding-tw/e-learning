...
2. **數位課程即時授權 (Instant Digital Access)**: 客戶完成付款後，系統立即自動開通其購買的數位課程、AI 程式碼生成工具與學習路徑授權。
...
* **課程與 AI 訂閱分潤 (Software Share)**: 對於由經銷商直接開發的在地客戶、學校或搭配硬體售出的數位課程，享有高比例的軟體分潤（Settlement Rate）。
...
| **數位課程與授權** | **義務**: 提供雲端課程平台維護、AI 工具授權與學習路徑更新。 | **權利**: 獲得授權推廣平台數位課程，並享有銷售分潤。 |
