...
- Main navigation login now launches Google Auth directly (`signInWithRedirect` in production, `signInWithPopup` in local emulator) instead of routing ordinary users through a separate login page first.
