...
const PREPARE_UNITS = [
  '01-unit-developer-identity.html',
  '01-unit-vscode-setup.html',
  '01-unit-vscode-online.html',
  '02-unit-vibe-coding-intro.html',
  '02-unit-classroom-workflow.html',
  '02-unit-teacher-matrix.html',
  '03-unit-wifi-setup.html',
  '03-unit-motor-ramping.html',
  '04-unit-agent-mode.html',
  '04-unit-web-agents.html',
  '04-unit-vibe-coding.html'
];
...
function patchUserTutorConfigs(doc) {
  ...
  for (const unit of PREPARE_UNITS) {
    tutorFields[unit] = {
      mapValue: {
        fields: {
...
function ensurePromoCode(courseId, existingMap) {
  ...
  const body = {
    fields: {
      ...
      source: { stringValue: 'manual_prepare_batch' },
