...
const courses = [
  // ─── prepare ───
  {
    ...
    courseUnits: ['tw-common-developer-identity.html', 'tw-common-vscode-online.html', 'tw-common-vscode-setup.html'],
  ...
  },
  {
    ...
    price: 0, category: 'prepare',
    courseUnits: ['tw-common-agent-mode.html', 'tw-common-vibe-coding.html', 'tw-common-web-agents.html'],
  ...
  },
  {
    ...
    price: 0, category: 'prepare',
    courseUnits: ['tw-common-github-classroom.html', 'tw-common-motor-ramping.html', 'tw-common-wifi-setup.html'],
    entryUnitId: 'tw-common-github-classroom.html',
    coreContent: ['GitHub Classroom 加入流程', '作業繳交方式', '自動評分系統'],
    orderWeight: 7, isPhysical: false,
  },
  {
    id: 'tw-common-wifi-motor',
