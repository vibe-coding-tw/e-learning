(function () {
  ...
  function hasLessonPriceData(lesson = {}) {
    return lesson.dealerPrice != null || normalizeText(lesson.dealerPriceBookId || lesson.dealerPriceBookLessonId || "") !== "";
  }
  ...
  function resolveLessonPrice(lesson = {}, currencyHint = "") {
    ...
    return {
      ...
      currency: normalizeCurrency(
        lesson.dealerCurrency || lesson.currency || currencyHint || "",
        ""
      ),
  ...
  function formatPrice(priceEntry = {}, locale = "zh-TW") {
    ...
    if (amount <= 0) return window.t('cart_price_free');
