(function () {
    ...
    const DICTIONARY = {
        "zh-TW": {
            ...
            "dash_tab_shipments": "出貨管理 (Shipments)",
            ...
            "dash_kit_shipment": "實體教材出貨",
            "dash_shipped": "已出貨",
            "dash_preparing": "準備中",
            "dash_my_shipments": "我的出貨狀態 (My Shipments)",
            "dash_shipment_order": "訂單",
            "dash_shipment_receiver": "收件人",
            "dash_shipment_phone": "電話",
            "dash_shipment_address": "物流地址",
            "dash_status": "狀態",
            "dash_to_ship": "待出貨",
        ...
        "en": {
            ...
            "highlight2": "Course milestones are visible and tangible, boosting students' sense of achievement and interest.",
            "highlight3": "Integrates Vibe Coding techniques, distinguishing it from other basic courses in the market.",
            ...
            "course_links_title": "Course Tracks",
            ...
            "login_card_desc": "System authorization and course access are unified under Google Account.",
            ...
            "empty_cart_msg": "Your shopping cart is empty! Go to the course listing page to add courses.",
            "cart_total_label": "Total (TWD):",
            ...
            "prefill_invite_missing": "The invite link is missing course parameters. Cannot add to cart.",
            ...
            "referral_item_not_in_cart": "The course/unit associated with this tutor invite link is not in your cart.",
            "referral_item_mismatch": "This tutor invite link does not match the current course item.",
            "referral_applied_success": "✅ Applied tutor invite link: {name}",

            // payment-return.html
            "pay_success_header": "Payment Successful!",
            "pay_success_desc": "Thank you for your purchase! Your course access has been activated.",
            "pay_order_status_label": "Order Status: ",
            "pay_order_status_paid": "Paid",
            "pay_next_step_label": "Next Step: ",
            "pay_next_step_desc": "You can now proceed to your courses to start learning.",
            "pay_note_label": "Note: ",
            ...
            "dash_tab_tutor_shipments": "Shipment Management",
            ...
            "dash_no_assignments": "No assigned tasks yet. Go to the \"Learning Path\" to enroll and start your first course!",
            ...
            "dash_tab_shipments": "Shipment Management",
            ...
            "dash_view_all_courses": "← View All Courses",
            ...
            "dash_graded": "Graded",
            "dash_no_assignments_submitted": "No assignments submitted for this course.",
            "not_provided": "Not provided",
            "dash_loading_readme": "Fetching GitHub instructions (README.md)...",
            "dash_learning_distribution": "Learning Distribution",
            "dash_course_progress_details": "Course Progress Details",
