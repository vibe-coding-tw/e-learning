    ...
    const mailOptions = {
        ...
        html: getEmailHtmlWrapper(
            ...
            locale === 'en' ? `
                ...
                ${renderPanel(`
                    <p style="margin: 0; font-weight: bold; color: #4f46e5; font-size: 14px; text-transform: uppercase;">🎁 Welcome Gift: 1-Month Free Access to Car Starter Courses</p>
                    <p style="margin: 10px 0 0 0;">To celebrate your arrival, you have free access to all <strong>"Car Starter"</strong> courses until:</p>
                ...
                ${renderNextSteps('Recommended Next Steps:', [
                    ...
                    'Select a Car Starter lesson and complete your first run.',
                ...
                <p style="margin-top: 14px; font-size: 14px;">
                    Or go directly to: <a href="${courseListUrl}" style="color: #4f46e5; text-decoration: none;">Car Starter Course Catalog</a> / <a href="${dashboardUrl}" style="color: #4f46e5; text-decoration: none;">Learning Dashboard</a>
                </p>
            ...
            ` : `
                ...
                ${renderPanel(`
                    <p style="margin: 0; font-weight: bold; color: #4f46e5; font-size: 14px; text-transform: uppercase;">🎁 限時歡迎禮：無人車入門課程免費使用一個月</p>
                    <p style="margin: 10px 0 0 0;">為了慶祝您加入，目前所有標記為<strong>「無人車入門」</strong>的課程，您皆可免費存取使用至：</p>
                    <p style="margin: 5px 0 0 0; font-size: 20px; font-weight: bold; color: #ef4444;">${resolvedExpiryStr}</p>
                `, { backgroundColor: '#f0f7ff', padding: '20px', margin: '25px 0', borderRadius: '8px', border: 'none', borderLeft: '4px solid #4f46e5' })}
                ...
                <p style="margin-top: 14px; font-size: 14px;">
                    或直接前往：<a href="${courseListUrl}" style="color: #4f46e5; text-decoration: none;">無人車入門課程列表</a> / <a href="${dashboardUrl}" style="color: #4f46e5; text-decoration: none;">學習儀表板</a>
                </p>
            ...
            `
                ${renderReminderBlock({
                    introHtml: `
                        ...
                        <p>把握最後的時間複習課程內容！如果您希望繼續存取這些內容或解鎖更多無人車進階課程，請考慮購買續約或查看最新優惠。</p>
                    `,
                    stepsTitle: '到期前建議完成：',
                    steps: [
                    '登入儀表板確認尚未完成的單元與作業。',
